...
Revision ID: a8227ae8e048
Revises: 
Create Date: 2026-01-21 20:29:44.284165
...
def upgrade():
    ...
    sa.Column('is_verified_instagram', sa.Boolean(), nullable=True),
    sa.Column('facebook', sa.Text(), nullable=True),
    sa.Column('is_verified_facebook', sa.Boolean(), nullable=True),
    sa.Column('twitter_x', sa.Text(), nullable=True),
    sa.Column('is_verified_twitter_x', sa.Boolean(), nullable=True),
    sa.Column('tiktok', sa.Text(), nullable=True),
    sa.Column('is_verified_tiktok', sa.Boolean(), nullable=True),
    ...
    sa.Column('is_prem_account', sa.Boolean(), nullable=True),
    ...
    sa.Column('num_reports_made', sa.Integer(), nullable=True),
    sa.Column('num_reports', sa.Integer(), nullable=True),
    sa.Column('profile_created_at', sa.DateTime(), server_default=sa.text('now()'), nullable=True),
    ...
    with op.batch_alter_table('block_profile', schema=None) as batch_op:
        batch_op.create_index('idx_block_user_blocked', ['blocked_id'], unique=False)
        batch_op.create_index('idx_block_user_blocker_blocked', ['blocker_id', 'blocked_id'], unique=False)
    ...
    with op.batch_alter_table('follow', schema=None) as batch_op:
        ...
        batch_op.create_index('idx_follow_following', ['following_id'], unique=False)
    ...
    sa.Column('total_num_of_ratings', sa.Integer(), nullable=True),
    ...
    sa.Column('num_of_edits', sa.Integer(), nullable=True),
    sa.Column('is_deleted', sa.Boolean(), nullable=True),
    sa.Column('deleted_at', sa.DateTime(timezone=True), nullable=True),
    sa.Column('num_reports', sa.Integer(), nullable=True),
    ...
    sa.Column('rating_choice', sa.Integer(), nullable=True),
    sa.Column('created_at', sa.DateTime(timezone=True), server_default=sa.text('now()'), nullable=True),
    ...
    sa.PrimaryKeyConstraint('rating_id', name=op.f('pk_rating')),
...
def downgrade():
    ...
    with op.batch_alter_table('follow', schema=None) as batch_op:
        batch_op.drop_index('idx_follow_following')
    ...
    with op.batch_alter_table('block_profile', schema=None) as batch_op:
        batch_op.drop_index('idx_block_user_blocker_blocked')
        batch_op.drop_index('idx_block_user_blocked')
