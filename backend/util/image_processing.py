...
def main():
    ...
    def image_processing(*images):
        ...
        for image in images:
            ...
            try:
                ...
                im.save('image_stripped_exif.jpg')
                thumbnail.save('thumbnail_stripped_exif.jpg')
    ...
    with open('backend/util/meexample.png', 'rb') as f:
        file_bytes = f.read()  # Same as Flask
        data = image_processing(file_bytes)
        print(data)
