...
media_executioner = ThreadPoolExecutor(thread_name_prefix='media', max_workers=settings.misc.MAX_CONCURRENT_IMAGES)
...
async def process_media_image(storage: ObjectStorage, obj_key: str, need_exif: bool, need_colors: bool) -> dict[Any, Any]:
    try:
        ...
        compressed_data = await loop.run_in_executor(media_executioner, process_in_thread, body)
