...
class Follow(base.BigIntBase):
    ...
    follower: Mapped["UserProfile"] = relationship(foreign_keys="Follow.follower_id", back_populates="follower")
    following: Mapped["UserProfile"] = relationship(foreign_keys="Follow.following_id",  back_populates="following")