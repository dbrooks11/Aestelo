...
export default function PostHeader(): JSX.Element{
    return(
        <div className="top-4 left-[50%] -translate-x-1/2 absolute flex flex-col justify-center items-center 
        border-neutral-300/30 bg-black/10 backdrop-blur-[2px] px-2 py-1 border text-xs text-white">
            ...
            <div className="flex justify-center items-center gap-2 text-nowrap">
                <span className="flex items-center gap-0.5 text-white/90"><Star strokeWidth={1} className="w-5 h-5 fill-yellow-400 stroke-yellow-400"/>2.1</span>
                <span>•</span>
